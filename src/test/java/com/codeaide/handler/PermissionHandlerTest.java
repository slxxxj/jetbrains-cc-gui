...
public class PermissionHandlerTest {
    ...
    public void safetyNetTimeoutFallsBackToDefaultPlusBufferWhenSettingsServiceIsNull() {
        ...
        long expected = CodeaideSettingsService.DEFAULT_PERMISSION_DIALOG_TIMEOUT_SECONDS
    ...
    private HandlerContext contextStub(CodeaideSettingsService settingsService) {
    ...
    private static class FailingSettingsService extends CodeaideSettingsService {
        @Override
        public int getPermissionDialogTimeoutSeconds() throws IOException {
