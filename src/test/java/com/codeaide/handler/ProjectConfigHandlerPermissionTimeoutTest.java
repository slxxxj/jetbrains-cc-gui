...
public class ProjectConfigHandlerPermissionTimeoutTest {
    ...
    private HandlerContext contextWith(CodeaideSettingsService settingsService) {
    ...
    private static class FakeSettingsService extends CodeaideSettingsService {
        ...
        public void setPermissionDialogTimeoutSeconds(int seconds) throws IOException {
            ...
            effectiveSeconds = CodeaideSettingsService.clampPermissionDialogTimeoutSeconds(seconds);
        }
