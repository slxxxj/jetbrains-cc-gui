...
public class ClaudeCliPathHandlerTest {
    ...
    public void validateRejectsNonExistentFile() {
        File missing = new File(System.getProperty("java.io.tmpdir"), "codeaide-claude-cli-missing-zzz");
    ...
    public void validateRejectsDirectory() throws IOException {
        File dir = Files.createTempDirectory("codeaide-claude-cli-dir").toFile();
        dir.deleteOnExit();
    ...
    public void validateRejectsNonExecutableFile() throws IOException {
        File file = Files.createTempFile("codeaide-claude-cli-noexec", ".bin").toFile();
        file.deleteOnExit();
    ...
    public void validateAcceptsExecutableFile() throws IOException {
        File file = Files.createTempFile("codeaide-claude-cli-ok", ".sh").toFile();
        file.deleteOnExit();
