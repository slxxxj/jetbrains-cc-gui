...
public class NodeProcessRegistryHelpersTest {
    ...
    public void looksLikeOurProcessMatchesDaemonJs() {
        assertTrue(NodeProcessRegistry.looksLikeOurProcess("node /Users/me/.codeaide/ai-bridge/daemon.js"));
    }

    @Test
    public void looksLikeOurProcessMatchesChannelManager() {
        assertTrue(NodeProcessRegistry.looksLikeOurProcess(
                "/usr/local/bin/node /Users/me/.codeaide/ai-bridge/channel-manager.js codex send"));
    }
    ...
    // (and vice-versa) when both run CodeAide side-by-side.
    // ============================================================================
