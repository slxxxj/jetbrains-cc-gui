...
public class SessionSendServiceTest {
    ...
    @Test
    public void normalizeRequestedSubagentModelTrimsAndRejectsBlank() {
        assertNull(SessionSendService.normalizeRequestedSubagentModel(null));
        assertNull(SessionSendService.normalizeRequestedSubagentModel(""));
        assertNull(SessionSendService.normalizeRequestedSubagentModel("   "));
        assertEquals("claude-haiku-4-5", SessionSendService.normalizeRequestedSubagentModel(" claude-haiku-4-5 "));
        // Model ids are open-ended (dynamic catalog, custom models) — any
        // non-blank value passes through unchanged.
        assertEquals("glm-4.7-flash", SessionSendService.normalizeRequestedSubagentModel("glm-4.7-flash"));
    }
