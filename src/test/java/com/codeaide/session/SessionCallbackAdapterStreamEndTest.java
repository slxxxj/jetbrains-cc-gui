 ...
 *
 * <p>The incremental upsert channel does not change this contract: the
 * end-of-stream flush still carries the authoritative full snapshot (pending
 * upserts are superseded and dropped inside the coalescer's flush), so the
 * primary/fallback onStreamEnd ordering validated here is unchanged.
 */
