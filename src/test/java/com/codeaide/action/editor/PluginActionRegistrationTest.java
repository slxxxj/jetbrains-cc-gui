package com.codeaide.action.editor;
...
public class PluginActionRegistrationTest {
    ...
    public void sendFilePathActionAppearsInProjectTreeAndEditorTabMenus() throws Exception {
        Set<String> groupIds = getActionGroupIds("CodeAide.SendFilePathToInputAction");
    ...
    public void copySelectionReferenceActionAppearsInEditorPopupMenuAfterSendSelectionAction() throws Exception {
        ActionRegistration action = getActionRegistration("CodeAide.CopySelectionReferenceAction");
        ActionRegistration quickFixAction = getActionRegistration("CodeAide.QuickFixWithClaudeAction");

        Assert.assertEquals(
                "com.codeaide.action.editor.CopySelectionReferenceAction",
                action.actionClass
        );
        AddToGroupRegistration editorPopup = action.getAddToGroup("EditorPopupMenu");
        Assert.assertEquals("after", editorPopup.anchor);
        Assert.assertEquals("CodeAide.SendSelectionToTerminalAction", editorPopup.relativeToAction);
    ...
    public void editorPopupActionsUseExpectedIcons() throws Exception {
        ActionRegistration sendSelectionAction = getActionRegistration("CodeAide.SendSelectionToTerminalAction");
        ActionRegistration copyReferenceAction = getActionRegistration("CodeAide.CopySelectionReferenceAction");
        ActionRegistration quickFixAction = getActionRegistration("CodeAide.QuickFixWithClaudeAction");

        Assert.assertEquals("/icons/codeaide-icon.svg", sendSelectionAction.icon);
        Assert.assertEquals("/icons/codeaide-icon.svg", copyReferenceAction.icon);
        Assert.assertEquals("/icons/codeaide-icon.svg", quickFixAction.icon);
    }

    @Test
    public void sessionTemplateActionsAreRegistered() throws Exception {
        ActionRegistration saveAsTemplateAction = getActionRegistration("CodeAide.SaveAsTemplateAction");
        ActionRegistration createFromTemplateAction = getActionRegistration("CodeAide.CreateFromTemplateAction");

        Assert.assertEquals("com.codeaide.action.SaveAsTemplateAction", saveAsTemplateAction.actionClass);
        Assert.assertEquals("com.codeaide.action.CreateFromTemplateAction", createFromTemplateAction.actionClass);
    }
