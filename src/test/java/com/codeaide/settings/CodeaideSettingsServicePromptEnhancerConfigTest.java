...
public class CodeaideSettingsServicePromptEnhancerConfigTest {
    ...
    private JsonObject invokeGetPromptEnhancerConfig(CodeaideSettingsService service) throws Exception {
        Method method;
        try {
            method = CodeaideSettingsService.class.getMethod("getPromptEnhancerConfig");
        } catch (NoSuchMethodException e) {
            fail("CodeaideSettingsService should expose getPromptEnhancerConfig()");
            throw e;
        }
    ...
    private void invokeSetPromptEnhancerConfig(
        ...
        try {
            ...
            fail("CodeaideSettingsService should expose setPromptEnhancerConfig(provider, claudeModel, codexModel)");
            throw e;
        }
