...
public class CodeaideSettingsServiceCommitAiConfigTest {
    ...
    private JsonObject invokeGetCommitAiConfig(CodeaideSettingsService service) throws Exception {
        Method method;
        try {
            method = CodeaideSettingsService.class.getMethod("getCommitAiConfig");
        } catch (NoSuchMethodException e) {
            fail("CodeaideSettingsService should expose getCommitAiConfig()");
            throw e;
        }
    ...
    private void invokeSetCommitAiConfig(
            CodeaideSettingsService service,
            String provider,
            String claudeModel,
            String codexModel
    ) throws Exception {
        ...
        try {
            ...
            fail("CodeaideSettingsService should expose setCommitAiConfig(provider, claudeModel, codexModel)");
            throw e;
        }
        method.invoke(service, provider, claudeModel, codexModel);
    }

    private JsonObject invokeGetPromptEnhancerConfig(CodeaideSettingsService service) throws Exception {
        Method method = CodeaideSettingsService.class.getMethod("getPromptEnhancerConfig");
        return (JsonObject) method.invoke(service);
    }
    ...
    private void invokeSetPromptEnhancerConfig(
        ...
        Method method = CodeaideSettingsService.class.getMethod(
