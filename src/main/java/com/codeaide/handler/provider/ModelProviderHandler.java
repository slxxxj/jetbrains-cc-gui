...
import com.codeaide.handler.UsagePushService;
import com.codeaide.handler.core.HandlerContext;

import com.codeaide.session.SessionSendService;
...
public class ModelProviderHandler {
    ...
    public void handleSetModel(String content) {
        try {
            ...
            com.codeaide.notifications.ClaudeNotifier.setModel(context.getProject(), model);
     ...
     * {@link com.codeaide.provider.claude.ClaudeSDKBridge#shutdownDaemon()})
