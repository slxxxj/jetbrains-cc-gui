...
public class CodexProviderOperations {
    ...
    public void handleAddCodexProvider(String content) {
        try {
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                context.callJavaScript("window.showError", context.escapeJs(com.codeaide.i18n.CodeAideBundle.message("provider.addCodexFailed", e.getMessage())));
            });
        }
    }
    ...
    public void handleUpdateCodexProvider(String content) {
        try {
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                context.callJavaScript("window.showError", context.escapeJs(com.codeaide.i18n.CodeAideBundle.message("provider.updateCodexFailed", e.getMessage())));
            });
        }
    }
    ...
    public void handleDeleteCodexProvider(String content) {
        ...
        try {
            ...
            if (!data.has("id")) {
                ...
                ApplicationManager.getApplication().invokeLater(() -> {
                    context.callJavaScript("window.showError", context.escapeJs(com.codeaide.i18n.CodeAideBundle.message("provider.deleteCodexMissingId")));
                });
                return;
            }
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                context.callJavaScript("window.showError", context.escapeJs(com.codeaide.i18n.CodeAideBundle.message("provider.deleteCodexFailed", e.getMessage())));
            });
        }
    ...
    private void invalidateCodexQuotaCache() {
        try {
            ApplicationManager.getApplication()
                    .getService(com.codeaide.service.CodexSubscriptionQuotaService.class)
                    .invalidateCache();
        } catch (Exception e) {
    ...
    public void handleSwitchCodexProvider(String content) {
        try {
            ...
            if (com.codeaide.settings.CodexProviderManager.CODEX_CLI_LOGIN_PROVIDER_ID.equals(id)) {
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                String successMsg = com.codeaide.i18n.CodeAideBundle.message("toast.providerSwitchSuccess")
                        + com.codeaide.i18n.CodeAideBundle.message("provider.switchSyncCodex");
    ...
    public void handleRevokeCodexLocalConfigAuthorization(String content) {
        try {
            ...
            boolean wasCliLoginActive = activeProvider != null
                    && activeProvider.has("id")
                    && com.codeaide.settings.CodexProviderManager.CODEX_CLI_LOGIN_PROVIDER_ID
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                context.callJavaScript("window.showSwitchSuccess", context.escapeJs(
                        com.codeaide.i18n.CodeAideBundle.message("toast.codexLocalConfigAuthorizationRevoked")));
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                context.callJavaScript("window.showError", context.escapeJs(
                        com.codeaide.i18n.CodeAideBundle.message("toast.providerSwitchFailed") + ": " + e.getMessage()));
            });
        }
    }
    ...
    private void handleSwitchToCodexCliLogin() {
        try {
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                context.callJavaScript("window.showSwitchSuccess", context.escapeJs(
                        com.codeaide.i18n.CodeAideBundle.message("toast.codexCliLoginSwitchSuccess")));
                handleGetCodexProviders();
                handleGetCurrentCodexConfig();
                handleGetActiveCodexProvider();
            });
