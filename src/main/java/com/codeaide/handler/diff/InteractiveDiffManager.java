package com.codeaide.handler.diff;
...
import com.codeaide.util.LineSeparatorUtil;
...
public class InteractiveDiffManager {
    ...
    private static void showInteractiveDiffInternal(
        ...
        // Create diff request
        String leftTitle = request.isNewFile() ? CodeAideBundle.message("diff.newFileTitle") : CodeAideBundle.message("diff.originalTitle");
        SimpleDiffRequest diffRequest = new SimpleDiffRequest(
                request.getTabName(),
                originalDiffContent,
                proposedDiffContent,
                leftTitle,
                CodeAideBundle.message("diff.proposedTitle")
        );
        ...
        JButton rejectButton = new JButton(CodeAideBundle.message("diff.reject"));
        ...
        JButton applyButton = new JButton(CodeAideBundle.message("diff.apply"));
        ...
        if (isPermissionReview) {
            JButton applyAlwaysButton = new JButton(CodeAideBundle.message("diff.applyAlways"));
    ...
    private static AnAction createRejectAction(
        ...
        return new AnAction(CodeAideBundle.message("diff.reject"), CodeAideBundle.message("diff.reject.description"), AllIcons.Actions.Cancel) {
            @Override
            @RequiresEdt
    ...
    private static AnAction createApplyAlwaysAction(
        ...
        return new AnAction(CodeAideBundle.message("diff.applyAlways"), CodeAideBundle.message("diff.applyAlways.description"), AllIcons.Actions.Checked_selected) {
            @Override
            @RequiresEdt
            public void actionPerformed(@NotNull AnActionEvent e) {
                if (actionApplied.compareAndSet(false, true)) {
    ...
    private static AnAction createApplyAction(
        ...
        return new AnAction(CodeAideBundle.message("diff.apply"), CodeAideBundle.message("diff.apply.description"), AllIcons.Actions.Checked) {
            @Override
            @RequiresEdt
            public void actionPerformed(@NotNull AnActionEvent e) {
                if (actionApplied.compareAndSet(false, true)) {
