        ...
        try {
            ...
            if (!isNewFile) {
                ...
                if (!file.exists()) {
                    ...
                    browserBridge.showErrorToast(CodeAideBundle.message("diff.fileNotFoundDetail", filePath));
        ...
        try {
            ...
            if (vFile != null) {
                ...
                try {
                    ...
                    browserBridge.showErrorToast(CodeAideBundle.message("diff.fileReadFailedDetail", e.getMessage()));
                    return;
                }
            }
            ...
            String tabName = CodeAideBundle.message("diff.tabName", fileName, operations.size());
            ...
            browserBridge.showErrorToast(CodeAideBundle.message("diff.openFailedDetail", e.getMessage()));
        }
    }
