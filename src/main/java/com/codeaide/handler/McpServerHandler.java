...
public class McpServerHandler extends BaseMessageHandler {
    ...
    private void handleAddMcpServer(String content) {
        try {
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                String errorMsg = escapeJs(com.codeaide.i18n.CodeAideBundle.message("mcp.addServerFailedWithReason", e.getMessage()));
    ...
    private void handleUpdateMcpServer(String content) {
        try {
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                String errorMsg = escapeJs(com.codeaide.i18n.CodeAideBundle.message("mcp.updateServerFailedWithReason", e.getMessage()));
                callJavaScript("window.showError", errorMsg);
            });
        }
    }
    ...
    private void handleDeleteMcpServer(String content) {
        try {
            ...
            if (success) {
                ...
                ApplicationManager.getApplication().invokeLater(() -> {
                    String reason = com.codeaide.i18n.CodeAideBundle.message("mcp.serverNotFound");
                    String errorMsg = escapeJs(com.codeaide.i18n.CodeAideBundle.message(
            ...
            ApplicationManager.getApplication().invokeLater(() -> {
                String errorMsg = escapeJs(com.codeaide.i18n.CodeAideBundle.message("mcp.deleteServerFailedWithReason", e.getMessage()));
                callJavaScript("window.showError", errorMsg);
            });
        }
    }
