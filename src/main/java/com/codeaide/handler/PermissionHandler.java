...
import com.codeaide.util.SystemNotificationService;
...
public class PermissionHandler extends BaseMessageHandler {
    ...
    long getSafetyNetTimeoutSeconds() {
        CodeaideSettingsService settingsService = context.getSettingsService();
        if (settingsService == null) {
            ...
            return CodeaideSettingsService.DEFAULT_PERMISSION_DIALOG_TIMEOUT_SECONDS
                    + CodeaideSettingsService.PERMISSION_SAFETY_NET_BUFFER_SECONDS;
        }
        try {
    ...
    public void showPermissionDialog(PermissionRequest request) {
        ...
        try {
            ...
            com.codeaide.ui.toolwindow.ClaudeChatWindow targetWindow =
                com.codeaide.ui.toolwindow.ClaudeSDKToolWindow.getChatWindow(targetProject);
