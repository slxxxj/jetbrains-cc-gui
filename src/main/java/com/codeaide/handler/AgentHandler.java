        ...
        try {
            ...
            if (agentId != null) {
                ...
                if (agent != null) {
                    ...
                    com.codeaide.notifications.ClaudeNotifier.setAgent(context.getProject(), agentName);
                } else {
                    com.codeaide.notifications.ClaudeNotifier.setAgent(context.getProject(), "");
                }
            } else {
                com.codeaide.notifications.ClaudeNotifier.setAgent(context.getProject(), "");
            }
    ...
    private void handleExportAgents(String content) {
        ApplicationManager.getApplication().invokeLater(() -> {
            try {
                ...
                com.codeaide.notifications.ClaudeNotifier.showError(
                        context.getProject(),
