package com.codeaide.handler.file;
...
public class FileExportHandler extends BaseMessageHandler {
    ...
    public boolean handle(String type, String content) {
        if ("save_markdown".equals(type)) {
            ...
            handleSaveFile(content, ".md", com.codeaide.i18n.CodeAideBundle.message("file.saveMarkdownDialog"));
            return true;
        } else if ("save_json".equals(type)) {
            LOG.info("[FileExportHandler] 处理: save_json");
            handleSaveFile(content, ".json", com.codeaide.i18n.CodeAideBundle.message("file.saveJsonDialog"));
            return true;
        }
        return false;
    }
    ...
    private void writeFileAsync(File fileToSave, String content) {
        CompletableFuture.runAsync(() -> {
            try (FileWriter writer = new FileWriter(fileToSave, StandardCharsets.UTF_8)) {
                ...
                notifySuccess(com.codeaide.i18n.CodeAideBundle.message("file.saved"));
            } catch (IOException e) {
                LOG.error("[FileExportHandler] 保存文件失败: " + e.getMessage(), e);
                String errorDetail = e.getMessage() != null ? e.getMessage() : com.codeaide.i18n.CodeAideBundle.message("file.saveFailed");
                notifyError(com.codeaide.i18n.CodeAideBundle.message("file.saveFailedWithReason", errorDetail));
            }
        });
    }
    ...
    private void notifyError(String message) {
        ApplicationManager.getApplication().invokeLater(() -> {
            String errorDetail = message != null ? message : com.codeaide.i18n.CodeAideBundle.message("file.unknownError");
            String errorMsg = escapeJs(com.codeaide.i18n.CodeAideBundle.message("file.saveFailedWithReason", errorDetail));
            String jsCode = "if (window.addToast) { " +
