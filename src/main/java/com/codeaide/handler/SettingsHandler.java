...
import com.codeaide.handler.provider.ModelProviderHandler;
    ...
    public boolean handle(String type, String content) {
        switch (type) {
            ...
            case "set_commit_generation_enabled":
                ...
                return true;
            case "get_commit_agent_config":
                projectConfigHandler.handleGetCommitAgentConfig();
                return true;
            case "set_commit_agent_config":
                projectConfigHandler.handleSetCommitAgentConfig(content);
                return true;
