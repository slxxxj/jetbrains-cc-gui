...
public class SessionHandler extends BaseMessageHandler {
    ...
    private String determineWorkingDirectory() {
        ...
        if (projectPath != null && new File(projectPath).exists()) {
            try {
                com.codeaide.settings.CodeaideSettingsService settingsService =
                        new com.codeaide.settings.CodeaideSettingsService();
    ...
    private String extractSubagentModel(JsonObject payload) {
        if (payload == null || !payload.has("subagentModel") || payload.get("subagentModel").isJsonNull()) {
            return null;
        }
