...
import com.codeaide.settings.AbstractPromptManager;
import com.codeaide.watcher.PromptFileWatcher;
...
public class PromptHandler extends BaseMessageHandler {
    ...
    public PromptHandler(HandlerContext context) {
        ...
        // Initialize file watcher to monitor .codeaide/prompt.json changes
