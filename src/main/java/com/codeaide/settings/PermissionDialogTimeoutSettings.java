...
public final class PermissionDialogTimeoutSettings {
    ...
    public static int getPermissionDialogTimeoutSeconds(CodeaideSettingsService service) throws IOException {
        ...
        try {
            ...
            LOG.warn("[CodeaideSettings] Invalid permissionDialogTimeoutSeconds value, rewriting default to disk; errorClass="
            ...
            try {
                ...
                LOG.warn("[CodeaideSettings] Failed to self-heal permissionDialogTimeoutSeconds; errorClass="
    ...
    public static void setPermissionDialogTimeoutSeconds(CodeaideSettingsService service, int seconds) throws IOException {
