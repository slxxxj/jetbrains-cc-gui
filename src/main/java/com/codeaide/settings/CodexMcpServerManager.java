 ...
 * Manages MCP server configurations in the effective Codex home's config.toml
 * (isolated ~/.codeaide/codex-home for managed providers, real ~/.codex in
 * CLI login mode).
 *
