...
public class PermissionDialog extends DialogWrapper {
    ...
    public PermissionDialog(@Nullable Project project, PermissionRequest request) {
        ...
        setTitle(CodeAideBundle.message("permission.dialogTitle"));
        setModal(true);
        setResizable(false);
    ...
    private void loadHtml() {
        try {
            ...
            if (is == null) {
                throw new RuntimeException(CodeAideBundle.message("permission.htmlNotFound"));
            }
            ...
            browser.loadHTML(CodeAideBundle.message("permission.loadFailed"));
        }
    }
    ...
    private String translateToolName(String toolName) {
        ...
        try {
            return CodeAideBundle.message(key);
        } catch (Exception e) {
            return toolName;
        }
    }
