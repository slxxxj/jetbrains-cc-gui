...
import com.codeaide.handler.diff.DiffResult;
import com.codeaide.handler.diff.InteractiveDiffManager;
import com.codeaide.handler.diff.InteractiveDiffRequest;
...
public class DiffReviewService {
    ...
    public static CompletableFuture<DiffReviewResult> reviewFileChange(
        ...
        try {
            ...
            String tabName = CodeAideBundle.message("diff.reviewTabName", fileName);
