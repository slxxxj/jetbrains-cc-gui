package com.codeaide.terminal;

import com.codeaide.i18n.CodeAideBundle;
import com.codeaide.util.SelectionTextUtils;
...
public class SendTerminalSelectionToInputAction extends AnAction implements DumbAware {
    ...
    static final String ACTION_ID = "CodeAide.SendTerminalSelectionToInputAction";
    ...
    public SendTerminalSelectionToInputAction() {
        super(
                CodeAideBundle.message("action.sendConsoleSelection.text"),
                CodeAideBundle.message("action.sendConsoleSelection.description"),
                null
        );
    }
