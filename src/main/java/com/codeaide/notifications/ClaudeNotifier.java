...
import com.codeaide.util.SoundNotificationService;
...
public class ClaudeNotifier {
    ...
    public static void setThinking(@NotNull Project project) {
        update(project, "thinking", CodeAideBundle.message("notifier.thinking"));
    }

    public static void setGenerating(@NotNull Project project) {
        update(project, "generating", CodeAideBundle.message("notifier.generating"));
    }

    public static void setWaiting(@NotNull Project project) {
        update(project, "waiting", CodeAideBundle.message("notifier.waiting"));
    }
