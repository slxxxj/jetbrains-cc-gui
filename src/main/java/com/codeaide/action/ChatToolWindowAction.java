 ...
 * Only enabled when the CodeAide tool window is active and focused.
 */
public abstract class ChatToolWindowAction extends AnAction implements DumbAware {
    ...
    private static final String TOOL_WINDOW_ID = "CodeAide";
    ...
    /**
     * Check if the CodeAide tool window is currently active (focused).
     */
