...
/**
 * Action to send file paths from the project tree to the CodeAide input box.
...
public class SendFilePathToInputAction extends AnAction implements DumbAware {
    ...
    public SendFilePathToInputAction() {
        super(
            CodeAideBundle.message("action.sendFilePath.text"),
            CodeAideBundle.message("action.sendFilePath.description"),
            null
        );
    }
    ...
    private void sendToChatWindow(@NotNull Project project, @NotNull String filePaths) {
        try {
            ...
            if (toolWindow != null) {
                ...
                LOG.error("CodeAide tool window not found");
            }
