...
public class QuickFixWithClaudeAction extends AnAction implements DumbAware {
    ...
    public QuickFixWithClaudeAction() {
        super(
            CodeAideBundle.message("action.quickFixWithClaude.text"),
            CodeAideBundle.message("action.quickFixWithClaude.description"),
            null
        );
    }
    ...
    private void showQuickFixInput(@NotNull Project project, @NotNull Editor editor) {
        ...
        JBLabel label = new JBLabel(CodeAideBundle.message("action.quickFixWithClaude.dialogLabel"));
        ...
        historyUpButton.setToolTipText(CodeAideBundle.message("action.quickFixWithClaude.historyUpTooltip"));
        ...
        historyDownButton.setToolTipText(CodeAideBundle.message("action.quickFixWithClaude.historyDownTooltip"));
        ...
        JButton submitButton = new JButton(CodeAideBundle.message("action.quickFixWithClaude.submit"));
        submitButton.setToolTipText(CodeAideBundle.message("action.quickFixWithClaude.submitTooltip"));

        JButton cancelButton = new JButton(CodeAideBundle.message("action.quickFixWithClaude.cancel"));
        cancelButton.setToolTipText(CodeAideBundle.message("action.quickFixWithClaude.cancelTooltip"));
        ...
        JBPopup popup = JBPopupFactory.getInstance()
                ...
                .setResizable(true)
                .setMovable(true)
                .setTitle(CodeAideBundle.message("action.quickFixWithClaude.dialogTitle"))
                .createPopup();
    ...
    private void executeQuickFix(@NotNull Project project, @NotNull Editor editor, @NotNull String userPrompt) {
        ...
        if (toolWindow == null) {
            ClaudeNotifier.showError(project, CodeAideBundle.message("quickfix.toolWindowNotFound"));
            return;
        }
        ...
        quickFixWindow.sendQuickFixMessage(userPrompt, true, new MessageCallback() {
            ...
            public void onError(String error) {
                ApplicationManager.getApplication().invokeLater(() -> {
                    ClaudeNotifier.showError(project, CodeAideBundle.message("quickfix.failed", error));
            ...
            public void onComplete(SDKResult result) {
                com.codeaide.service.QuickFixService.handleAIResponse(project, editor, result.finalResult);
            }
        });
    }
