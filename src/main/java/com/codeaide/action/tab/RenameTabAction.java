...
/**
 * Action to rename the current tab in the CodeAide tool window.
...
public class RenameTabAction extends AnAction implements DumbAware {
    ...
    public RenameTabAction() {
        super(
            CodeAideBundle.message("action.renameTab.text"),
            CodeAideBundle.message("action.renameTab.description"),
            null
        );
    }
    ...
    public void actionPerformed(@NotNull AnActionEvent e) {
        ...
        String newName = Messages.showInputDialog(
            project,
            CodeAideBundle.message("action.renameTab.dialogLabel"),
            CodeAideBundle.message("action.renameTab.dialogTitle"),
            null,
            currentName,
    ...
    private static class TabNameInputValidator implements InputValidatorEx {
        ...
        public @Nullable String getErrorText(@Nullable String inputString) {
            if (inputString == null || inputString.trim().isEmpty()) {
                return CodeAideBundle.message("action.renameTab.error.empty");
            }
            if (inputString.trim().length() > MAX_TAB_NAME_LENGTH) {
                return CodeAideBundle.message("action.renameTab.error.tooLong");
            }
            return null;
        }
    }
