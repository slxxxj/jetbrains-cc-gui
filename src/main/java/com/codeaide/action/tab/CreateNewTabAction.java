...
/**
 * Action to create a new chat tab in the CodeAide tool window
 */
public class CreateNewTabAction extends AnAction {
    ...
    public CreateNewTabAction() {
        super(
            CodeAideBundle.message("action.createNewTab.text"),
            CodeAideBundle.message("action.createNewTab.description"),
            null
        );
    }
