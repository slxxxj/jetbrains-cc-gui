...
/**
 * Watches for changes to .codeaide/prompt.json files and notifies listeners.
...
public class PromptFileWatcher implements BulkFileListener {
     ...
     * Pattern: <project-path>/.codeaide/prompt.json
     */
