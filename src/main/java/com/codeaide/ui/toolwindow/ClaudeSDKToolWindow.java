...
import com.codeaide.ui.detached.DetachedWindowManager;
...
public class ClaudeSDKToolWindow implements ToolWindowFactory, DumbAware {
    ...
    public static final String TOOL_WINDOW_ID = "CodeAide";
    public static final String TOOL_WINDOW_DISPLAY_NAME = "CodeAide";
    ...
    public void createToolWindowContent(@NotNull Project project, @NotNull ToolWindow toolWindow) {
        ...
        if (PlatformUtils.isPluginDevMode()) {
            com.intellij.openapi.actionSystem.AnAction devToolsAction =
                    com.intellij.openapi.actionSystem.ActionManager.getInstance()
                            .getAction("CodeAide.OpenDevToolsAction");
        ...
        com.intellij.openapi.actionSystem.AnAction saveAsTemplateAction =
                com.intellij.openapi.actionSystem.ActionManager.getInstance()
                        .getAction("CodeAide.SaveAsTemplateAction");
        com.intellij.openapi.actionSystem.AnAction createFromTemplateAction =
                com.intellij.openapi.actionSystem.ActionManager.getInstance()
                        .getAction("CodeAide.CreateFromTemplateAction");
        ...
        contentManager.addContentManagerListener(new ContentManagerListener() {
            ...
            public void selectionChanged(@NotNull ContentManagerEvent event) {
                ...
                if (window != null) {
                    ...
                    window.checkWebviewHealthOnTabSelected();
                }
            }
            ...
            public void contentRemoveQuery(@NotNull ContentManagerEvent event) {
                ...
                int result = com.intellij.openapi.ui.Messages.showYesNoDialog(
                    project,
                    CodeAideBundle.message("tab.close.confirm.message", tabName),
                    CodeAideBundle.message("tab.close.confirm.title"),
                    CodeAideBundle.message("tab.close.confirm.yes"),
                    CodeAideBundle.message("tab.close.confirm.no"),
    ...
    private JPanel createLoadingPanel() {
        ...
        panel.setBackground(com.codeaide.util.ThemeConfigService.getBackgroundColor());
        ...
        JLabel textLabel = new JLabel(CodeAideBundle.message("toolwindow.preparingBridge"));
