...
public class TemplateSelectionDialog extends DialogWrapper {
    ...
    public TemplateSelectionDialog() {
        super(true);
        setTitle(CodeAideBundle.message("template.select.title"));
        setOKButtonText(CodeAideBundle.message("template.select.ok"));
        setCancelButtonText(CodeAideBundle.message("template.select.cancel"));
    ...
    protected @Nullable JComponent createCenterPanel() {
        ...
        if (listModel.isEmpty()) {
            JLabel emptyLabel = new JLabel(CodeAideBundle.message("template.select.empty"));
