...
public class ErrorPanelBuilder {
    ...
    public static JPanel build(String title, String message, String currentNodePath, Consumer<String> onSaveAndRetry) {
        ...
        JLabel nodeLabel = new JLabel(com.codeaide.i18n.CodeAideBundle.message("error.nodePathLabel"));
        ...
        JButton saveAndRetryButton = new JButton(com.codeaide.i18n.CodeAideBundle.message("error.saveButton"));
