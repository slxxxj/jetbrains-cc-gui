package com.codeaide.ui.detached;
...
public class DetachedChatFrame extends JFrame {
    ...
    private JPanel createToolbar() {
        ...
        // Reattach button
        JButton reattachBtn = new JButton(CodeAideBundle.message("detachedWindow.reattach"));
        reattachBtn.setToolTipText(CodeAideBundle.message("detachedWindow.reattach.tooltip"));
    ...
    private void onWindowClosing() {
        ...
        int choice = Messages.showYesNoCancelDialog(
                project,
                CodeAideBundle.message("detachedWindow.close.message"),
                CodeAideBundle.message("detachedWindow.close.title"),
                CodeAideBundle.message("detachedWindow.close.reattach"),
                CodeAideBundle.message("detachedWindow.close.destroy"),
                CodeAideBundle.message("detachedWindow.close.cancel"),
            ...
            try {
                ...
                if (toolWindow == null) {
                    ...
                    Messages.showErrorDialog(
                            this.project,
                            CodeAideBundle.message("detachedWindow.reattach.error.noToolWindow"),
                            CodeAideBundle.message("detachedWindow.reattach.error.title")
                    );
                    return;
                }
                ...
                Messages.showErrorDialog(
                        this.project,
                        CodeAideBundle.message("detachedWindow.reattach.error.failed") + ": " + e.getMessage(),
                        CodeAideBundle.message("detachedWindow.reattach.error.title")
                );
            }
        });
    ...
    private void syncTabStateWithToolWindow() {
        try {
            ...
            if (toolWindow != null) {
                ...
                com.codeaide.settings.TabStateService.getInstance(this.project)
