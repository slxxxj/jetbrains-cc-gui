 ...
 * - Global: ~/.codeaide/skills/global
 * - Local: ~/.codeaide/skills/{project-path-hash}
 */
public class SkillService {
    ...
    private static final String CONFIG_DIR_NAME = ".codeaide";
    ...
    /**
     * Gets the management directory root path (~/.codeaide/skills).
     */
    ...
    /**
     * Gets the global skills management directory (~/.codeaide/skills/global).
     */
    ...
    /**
     * Gets the local skills management directory (~/.codeaide/skills/{project-path-hash}).
