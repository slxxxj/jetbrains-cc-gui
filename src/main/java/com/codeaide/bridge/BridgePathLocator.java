...
import com.codeaide.util.PluginMetadata;
...
final class BridgePathLocator {
    ...
    static final String PLUGIN_DIR_NAME = "codeaide";
    static final String BRIDGE_PATH_PROPERTY = "codeaide.bridge.path";
     ...
     * They are loaded dynamically from ~/.codeaide/dependencies/, so SDK presence is not checked here.
     */
    static boolean isValidBridgeDir(File dir) {
        ...
        // are loaded dynamically from ~/.codeaide/dependencies/, no need to check within ai-bridge
