...
public class FontConfigService {
    ...
    private static final String UI_FONT_CUSTOM_FAMILY = "CodeAide UI Custom";
    private static final String CODE_FONT_CUSTOM_FAMILY = "CodeAide Code Custom";
     ...
     */
    public static JsonObject getResolvedUiFontConfig(CodeaideSettingsService settingsService) {
        try {
     ...
     */
    public static JsonObject getResolvedCodeFontConfig(CodeaideSettingsService settingsService) {
        try {
     ...
     */
    public static String getResolvedUiFontConfigJson(CodeaideSettingsService settingsService) {
     ...
     */
    public static String getResolvedCodeFontConfigJson(CodeaideSettingsService settingsService) {
