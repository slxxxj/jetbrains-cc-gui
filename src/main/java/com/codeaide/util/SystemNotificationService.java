...
public class SystemNotificationService {
    ...
    public void showAskUserQuestionReminderToast(@NotNull Project project) {
        showVisualNotificationToast(project,
            CodeAideBundle.message("notifier.askUserQuestion.title"),
            CodeAideBundle.message("notifier.askUserQuestion.message"),
    ...
    private boolean isTaskCompletionEnabled() {
        try {
            return new CodeaideSettingsService().getTaskCompletionNotificationEnabled();
        } catch (Exception e) {
    ...
    private boolean isAskUserQuestionEnabled() {
        try {
            return new CodeaideSettingsService().getAskUserQuestionNotificationEnabled();
        } catch (Exception e) {
    ...
    private String sanitizeTitle(@Nullable String raw) {
        String chosen = (raw == null || raw.trim().isEmpty())
            ? CodeAideBundle.message("notifier.taskComplete.title")
            : raw.trim();
